[![Travis build status shield](https://img.shields.io/travis/y-lohse/cozy-bin/master.svg)](https://travis-ci.org/y-lohse/cozy-bin)
[![Github Release version shield](https://img.shields.io/github/tag/y-lohse/cozy-bin.svg)](https://github.com/y-lohse/cozy-bin/releases)
...
Hacking the Cozy cozy-bin app requires you to [setup a dev environment][setup].

You can then clone the app repository and install dependencies:

```sh
$ git clone https://github.com/y-lohse/cozy-bin.git
$ cd cozy-bin
$ yarn install
```
...
$ docker run --rm -it -p 8080:8080 -v "$(pwd)/build":/data/cozy-app/cozy-bin cozy/cozy-app-dev
or
$ yarn stack:docker
```

your app is available at http://cozy-bin.cozy.tools:8080.
...
If you want to work on cozy-bin and submit code modifications, feel free to open pull-requests! See the [contributing guide][contribute] for more information about how to properly open pull-requests.
...
The lead maintainer for cozy-bin is [y-lohse](https://github.com/y-lohse), send him/her a :beers: to say hello!
...
cozy-bin is developed by y-lohse and distributed under the [AGPL v3 license][agpl-3.0].
